...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('parent_id', \App\Models\Category::where("status",true)->pluck("titleRu","id") ,null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('categories.index') }}" class="btn btn-secondary">{{__("validation.attributes.Cancel")}}</a>
</div>
