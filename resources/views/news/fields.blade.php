...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('category_id',(\App\Models\NewsCategory::where(["status"=>true])->pluck("titleRu","id")->toArray()),null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('news.index') }}" class="btn btn-secondary">{{__("validation.attributes.Cancel")}}</a>
</div>
